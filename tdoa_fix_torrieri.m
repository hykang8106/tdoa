...
% sensor position: dimension = sensor_length x 2
sensor_position = [sensor_1; sensor_2; sensor_3; sensor_4];

delta_distance_meter = [delta_distance_12, delta_distance_13, delta_distance_14];
