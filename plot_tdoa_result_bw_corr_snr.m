function [] = plot_tdoa_result_bw_corr_snr(filename, snr_idx, nsubframe_idx)
% plot result of batch_simulate_tdoa_bw_corr_snr.m
%
% [input]
% - filename: if empty, dialog box is displayed for file selection
%   tdoa result file name which include 'tdoa_result_bw_corr_snr' string
% - snr_idx: snr index. positive integer
% - nsubframe_idx: nsubframe index. positive integer
%
% [usage]
% plot_tdoa_result_bw_corr_snr('', 1, 1)
%
