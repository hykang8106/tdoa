...
%         sub_pb_input_param_call(S);
        ...
        S.fh;
        S.SEL_old;
        S.SEL = find(S.rd == sel);  % S.SEL store current radiobutton.
...
%             set(S.fh(2), 'windowstyle', 'normal');
        ...
        function [] = fh_sub_crfcn(varargin)
            ...
            % ###### when sub figure(S.fh(2) is deleted, 
            % ###### sub figure handle remains in the workspace but no longer points to an object.
            % ###### you can use "ishghandle" command to check validity of handle
