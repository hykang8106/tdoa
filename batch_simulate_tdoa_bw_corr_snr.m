function [] = batch_simulate_tdoa_bw_corr_snr(sensor_length, sensor_exist_at_uca_center, ...
    uca_radius_meter, ...
...
% ### make subroutine for gui_sim_tdoa
[filename] = sub_batch_simulate_tdoa_bw_corr_snr(sensor_position, uca_radius_meter, ...
    target_position, radius_ratio, trial_length, rician_param, ...
