...
Radius = 50; % microphone array radius
N = 8; % microphone number in array

% generate sensor(microphone) array poistion
...
Z = (-1).^Z;
Z = 5*Z+5;
Sen_position = [X.',Y.',Z.']; % microphone array position
...
% what is padding? 44100 = audio sample rate?
...
%     name = strcat( 'Trial_', istr, '_', xstr, '_', ystr, '_', zstr, '_mdove.wav');
    ...
    % this make signal delay when sensor receive signal
