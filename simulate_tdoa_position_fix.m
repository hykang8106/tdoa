function [position_error_hyperbolic, position_error_linear, position_error_torrieri] = ...
    simulate_tdoa_position_fix(rf_sensor_length, snr_db, randomize_sensor_distance)
...
%   ##### even when 1, working!!!
% [usage]
% simulate_tdoa_position_fix(4, 5, 1);
%
...
[position_error_hyperbolic, position_error_linear, position_error_torrieri] = ...
    locate_target_tdoa(rf_sensor, ref_sensor_number, delta_distance_meter, rx, info.SamplingRate, snr_db);
