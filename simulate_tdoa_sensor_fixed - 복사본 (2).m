function [position_error_torrieri, x_est_torrieri] = ...
    simulate_tdoa_sensor_fixed(sensor_length, sensor_exist_at_uca_center, uca_radius_meter, snr_db, ...
    target_position, radius_ratio, sensor_position_filename)
...
% simulate_tdoa_sensor_fixed(4, 1, 7e3, 5, [1055, -3000], 1, 'sensor_position.txt');
%
...
[position_error_torrieri, x_est_torrieri] = ...
...
%     locate_target_tdoa(sensor_position, ref_sensor_number, delta_distance_meter, rx_signal, info.SamplingRate, ...
%     snr_db, use_only_torrieri_method, target_position);
