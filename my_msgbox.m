function [h] = my_msgbox(msg_text, msg_title, msg_icon, create_mode, font_size, text_color)
% change font size and color of text in msgbox
% to modify code, use learn_msgbox.m
%
...
% - msg_text:
% - msg_title:
% - msg_icon: [](empty) | 'error' | 'help' | 'warn'
% - create_mode: 'modal' | 'nonmodal'(default)
%
% [usage]
% my_msgbox('test completed, end of winter, spring come', 'info', 'help', 'modal', 14, 'b')
% my_msgbox('test completed, end of winter, spring come', 'info', [], 'modal', 14, 'b')
